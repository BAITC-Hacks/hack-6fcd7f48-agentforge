...
Фактический набор: 2 248 узлов, 3 119 рёбер, 4 840 транзакций, 81 seed, 91 кластер, 35 слабосвязных компонент (19 изолятов) и 444 узла depth=4. Детали и ограничения интерпретации — в [методологии](methodology.md).
